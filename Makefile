...
gtcomputation_kji.o: gtcomputation_kji.cpp
	g++ -o gtcomputation_kji.o gtcomputation_kji.cpp -std=c++14 $(INCLUDES) -c -fPIC
...
gtcomputation.o: gtcomputation.cpp
	g++ -o gtcomputation.o gtcomputation.cpp -std=c++14 $(INCLUDES) -c -fPIC
...
copy_simple.o: copy_simple.cpp
	g++ -o copy_simple.o copy_simple.cpp -std=c++14 $(INCLUDES) -c -fPIC

copy_simple.so: copy_simple.o
	g++ -shared -o copy_simple.so copy_simple.o -lpython3.7m -fPIC

gtboundary.o: gtboundary.cpp
	g++ -o gtboundary.o gtboundary.cpp -std=c++14 $(INCLUDES) -c -fPIC
...
gtcomputation_struct.o: gtcomputation_struct.cpp
	g++ -o gtcomputation_struct.o gtcomputation_struct.cpp -std=c++14 $(INCLUDES) -c -fPIC
